...
- [x] Write the V2 report from PoLar reproduction gaps to retrieval-aware path learning.
...
- [ ] Specify the fixed multimodal Candidate path bank and leakage-free retrieval splits.
- [ ] Implement retrieval-ranking reward and coverage-based MCTS path-bank discovery.
- [ ] Implement rejoin-layer drift, spherical latent drift, pullback, and trust-radius metrics.
